...
/* API list --------------------------------------------------------------------------------------------------- */
/* cx_vec2 ---------------------------------------------------------------------------------------------------- */
CX_API CX_API_INLINE cx_vec2 *cx_vec2_set_zero(cx_vec2 *u);                                           /* Returns zero vec2 */
CX_API CX_API_INLINE cx_vec2 *cx_vec2_set(cx_vec2 *u, CX_FLOAT x, CX_FLOAT y);                        /* Set vec2 with x, y */
CX_API CX_API_INLINE cx_vec2 *cx_vec2_set_random(cx_vec2 *u);                                         /* Set vec2 with random values */
...
CX_API CX_API_INLINE cx_vec2 cx_vec2_subtract(const cx_vec2 *u, const cx_vec2 *v);             /* Returns the subtraction of two vec2 */
CX_API CX_API_INLINE cx_vec2 cx_vec2_subtractf(const cx_vec2 *u, const CX_FLOAT fT);                  /* Returns the addition of a vec2 with a scalar eg. cx_vec2 u = <9.0f, 10.0f>, fT = 10, -> <19.0f, 20.0f> */
CX_API CX_API_INLINE cx_vec2 cx_vec2_scalar_multiplyf(const cx_vec2 *u, const CX_FLOAT fT);           /* Returns the scalar multiplication of a vec2. eg: u = <1.0f, 3.0f> and f = 3.0f => <3.0f, 9.0f> */
CX_API CX_API_INLINE cx_vec2 cx_vec2_dividef(const cx_vec2 *u, const CX_FLOAT fT);

CX_API CX_API_INLINE CX_FLOAT cx_vec2_dot_product(const cx_vec2 *u, const cx_vec2 *v);                /* Returns the dot product b/w two vec2 */
CX_API CX_API_INLINE CX_FLOAT cx_vec2_cross_product(const cx_vec2 *u, const cx_vec2 *v);              /* Returns the cross product b/w two vec2 */

CX_API CX_API_INLINE cx_vec2 cx_vec2_normalize(const cx_vec2 *u);                                     /* Returns the norm of a vec2 */
CX_API CX_API_INLINE CX_FLOAT cx_vec2_magnitude(const cx_vec2 *u);                                           /* Returns the magnitude of a vec2 */

CX_API CX_API_INLINE void cx_vec2_print(const cx_vec2 *u);                                                   /* Print vec2 */

/* cx_vec3 ---------------------------------------------------------------------------------------------------- */
CX_API CX_API_INLINE cx_vec3 *cx_vec3_set_zero(cx_vec3 *u);                                           /* Returns zero vec3 */
CX_API CX_API_INLINE cx_vec3 *cx_vec3_set(cx_vec3 *u, CX_FLOAT x, CX_FLOAT y, CX_FLOAT z);            /* Set a vec3 with x, y */
CX_API CX_API_INLINE cx_vec3 *cx_vec3_set_random(cx_vec3 *u);                                         /* Set vec3 with random vaules */
...
CX_API CX_API_INLINE cx_vec3 cx_vec3_subtract(const cx_vec3 *u, const cx_vec3 *v);             /* Returns the subtraction of two vec3 */
CX_API CX_API_INLINE cx_vec3 cx_vec3_subtractf(const cx_vec3 *u, const CX_FLOAT fT);                  /* Returns the subtraction of a vec3 with a scalar eg. cx_vec3 u = <9.0f, 10.0f, 0.5f>, fT = 10, -> <19.0f, 20.0f, 10.5f> */
CX_API CX_API_INLINE cx_vec3 cx_vec3_scalar_multiplyf(const cx_vec3 *u, const CX_FLOAT fT);           /* Returns the scalar multiplication of a vec3. eg: u = <1.0f, 3.0f, 0.5f> and f = 3.0f => <3.0f, 9.0f, 1.5f> */
CX_API CX_API_INLINE cx_vec3 cx_vec3_dividef(const cx_vec3 *u, const CX_FLOAT fT);

CX_API CX_API_INLINE CX_FLOAT cx_vec3_dot_product(const cx_vec3 *u, const cx_vec3 *v);                /* Returns the dot product b/w two vec3 */
CX_API CX_API_INLINE cx_vec3 cx_vec3_cross_product(const cx_vec3 *u, const cx_vec3 *v);        /* Returns the cross product b/w two vec3 */

CX_API CX_API_INLINE cx_vec3 cx_vec3_normalize(const cx_vec3 *u);                                     /* Returns the norm of a vec3 */
CX_API CX_API_INLINE CX_FLOAT cx_vec3_magnitude(const cx_vec3 *u);                                           /* Returns the magnitude of a vec3 */

CX_API CX_API_INLINE void cx_vec3_print(const cx_vec3 *u);                                                   /* Print vec3 */

/* cx_vec4 ---------------------------------------------------------------------------------------------------- */
CX_API CX_API_INLINE cx_vec4 *cx_vec4_set_zero(cx_vec4 *u);
CX_API CX_API_INLINE cx_vec4 *cx_vec4_set(cx_vec4 *u, CX_FLOAT x, CX_FLOAT y, CX_FLOAT z, CX_FLOAT w);
CX_API CX_API_INLINE cx_vec4 *cx_vec4_set_random(cx_vec4 *u);
...
CX_API CX_API_INLINE cx_vec4 cx_vec4_subtract(const cx_vec4 *u, const cx_vec4 *v);
CX_API CX_API_INLINE cx_vec4 cx_vec4_subtractf(const cx_vec4 *u, CX_FLOAT fT);
CX_API CX_API_INLINE cx_vec4 cx_vec4_scalar_multiplyf(const cx_vec4 *u, CX_FLOAT fT);
CX_API CX_API_INLINE cx_vec4 cx_vec4_dividef(const cx_vec4 *u, const CX_FLOAT fT);

CX_API CX_API_INLINE CX_FLOAT cx_vec4_dot_product(const cx_vec4 *u, const cx_vec4 *v);
CX_API CX_API_INLINE cx_vec4 cx_vec4_cross_product(const cx_vec4 *u, const cx_vec4 *v);

CX_API CX_API_INLINE cx_vec4 cx_vec4_normalize(const cx_vec4 *u);
CX_API CX_API_INLINE CX_FLOAT cx_vec4_magnitude(const cx_vec4 *u);
...
CX_API CX_API_INLINE cx_vec2 *cx_vec2_set(cx_vec2 *u, CX_FLOAT x, CX_FLOAT y)
{
  	u->x = x;
  	u->y = y;
  	return u;
...
CX_API CX_API_INLINE cx_vec2 *cx_vec2_set_random(cx_vec2 *u)
{
  	u->x = CX_RANDOM_FLOAT;
  	u->y = CX_RANDOM_FLOAT;
  	return u;
...
CX_API CX_API_INLINE cx_vec2 *cx_vec2_set_zero(cx_vec2 *u)
{
...
CX_API CX_API_INLINE cx_vec2 cx_vec2_subtract(const cx_vec2 *u, const cx_vec2 *v)
{
  	return (struct cx_vec2) {   .x = u->x - v->x,
  	                            .y = u->y - v->y
  	};
...
CX_API CX_API_INLINE cx_vec2 cx_vec2_subtractf(const cx_vec2 *u, const CX_FLOAT fT)
{
  	return (struct cx_vec2) {   .x = u->x - fT,
  	                            .y = u->y - fT
  	};
...
CX_API CX_API_INLINE cx_vec2 cx_vec2_scalar_multiplyf(const cx_vec2 *u, const CX_FLOAT fT)
{
...
CX_API CX_API_INLINE CX_FLOAT cx_vec2_dot_product(const cx_vec2 *u, const cx_vec2 *v)
{
  	return (u->x * v->x + u->y * v->y);
}

CX_API CX_API_INLINE CX_FLOAT cx_vec2_cross_product(const cx_vec2 *u, const cx_vec2 *v)
{
...
CX_API CX_API_INLINE CX_FLOAT cx_vec2_magnitude(const cx_vec2 *u)
{
...
CX_API CX_API_INLINE cx_vec3 *cx_vec3_set_zero(cx_vec3 *u)
{
  	u->x = 0;
  	u->y = 0;
  	u->z = 0;
...
CX_API CX_API_INLINE cx_vec3 *cx_vec3_set(cx_vec3 *u, CX_FLOAT x, CX_FLOAT y, CX_FLOAT z)
{
  	u->x = x;
  	u->y = y;
  	u->z = z;
...
CX_API CX_API_INLINE cx_vec3 *cx_vec3_set_random(cx_vec3 *u)
{
  	u->x = CX_RANDOM_FLOAT;
  	u->y = CX_RANDOM_FLOAT;
  	u->z = CX_RANDOM_FLOAT;
...
CX_API CX_API_INLINE cx_vec3 cx_vec3_subtract(const cx_vec3 *u, const cx_vec3 *v)
{
  	return (cx_vec3) {   .x = u->x - v->x,
                         .y = u->y - v->y,
                         .z = u->z - v->z
...
CX_API CX_API_INLINE cx_vec3 cx_vec3_subtractf(const cx_vec3 *u, const CX_FLOAT fT)
{
  	return (cx_vec3) {   .x = u->x - fT,
                         .y = u->y - fT,
                         .z = u->z - fT
...
CX_API CX_API_INLINE cx_vec3 cx_vec3_scalar_multiplyf(const cx_vec3 *u, const CX_FLOAT fT)
{
...
CX_API CX_API_INLINE CX_FLOAT cx_vec3_dot_product(const cx_vec3 *u, const cx_vec3 *v)
{
  	return (u->x * v->x + u->y * v->y + u->z * v->z);
}

CX_API CX_API_INLINE cx_vec3 cx_vec3_cross_product(const cx_vec3 *u, const cx_vec3 *v)
{
...
CX_API CX_API_INLINE CX_FLOAT cx_vec3_magnitude(const cx_vec3 *u)
{
